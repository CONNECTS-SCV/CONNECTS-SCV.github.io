...
export function createEmailTemplate(
  ...
  const templates = {
    newsletter: {
      ko: {
        subject: `Curieus 뉴스레터 - ${new Date().toLocaleDateString('ko-KR')}`,
        body: `
<!DOCTYPE html>
<html>
<head>
...
<body>
  <div class="container">
    <div class="header">
      <h1>Curieus Newsletter</h1>
      <p>AI 기반 구조 생물학 분석 플랫폼</p>
    </div>
    <div class="content">
      <p>안녕하세요,</p>
      <p>이번 주 Curieus의 새로운 소식을 전해드립니다.</p>
      ...
      <div class="footer">
        <p>감사합니다.<br>Curieus 팀</p>
        <p>이 이메일은 Curieus 뉴스레터를 구독하신 분들께 발송되었습니다.</p>
      </div>
    </div>
  </div>
</body>
      ...
      en: {
        subject: `Curieus Newsletter - ${new Date().toLocaleDateString('en-US')}`,
        body: `
<!DOCTYPE html>
<html>
<head>
...
<body>
  <div class="container">
    ...
    <div class="content">
      <p>Hello,</p>
      <p>Here are this week's updates from Curieus.</p>
      ...
      <div class="footer">
        <p>Best regards,<br>Curieus Team</p>
        <p>This email was sent to Curieus newsletter subscribers.</p>
      </div>
    </div>
  </div>
</body>
    ...
    announcement: {
      ko: {
        subject: 'Curieus 중요 공지사항',
        body: `<p>안녕하세요,</p><p>${data?.content || '중요한 공지사항이 있습니다.'}</p><p>감사합니다.<br>Curieus 팀</p>`,
        isHtml: true
      },
      en: {
        subject: 'Curieus Important Announcement',
        body: `<p>Hello,</p><p>${data?.content || 'We have an important announcement.'}</p><p>Best regards,<br>Curieus Team</p>`,
        isHtml: true
      }
    },
    welcome: {
      ko: {
        subject: 'Curieus 뉴스레터 구독을 환영합니다!',
        body: `<p>안녕하세요,</p><p>Curieus 뉴스레터를 구독해주셔서 감사합니다.</p><p>앞으로 최신 소식과 업데이트를 이메일로 받아보실 수 있습니다.</p><p>감사합니다.<br>Curieus 팀</p>`,
        isHtml: true
      },
      en: {
        subject: 'Welcome to Curieus Newsletter!',
        body: `<p>Hello,</p><p>Thank you for subscribing to Curieus Newsletter.</p><p>You will receive the latest news and updates via email.</p><p>Best regards,<br>Curieus Team</p>`,
        isHtml: true
      }
    },
    custom: {
