  ...
  a: ({ href, children, className, ...props }: any) => {
    ...
    const handleClick = (e: React.MouseEvent) => {
      ...
      const toolUrls: { [key: string]: string } = {
        'Abdev': 'https://curieus.net/Analysis/abdev?from=blog',
        'ADMET-AI': 'https://curieus.net/Analysis/admet-ai?from=blog',
        'Antifold': 'https://curieus.net/Analysis/antifold?from=blog',
        'Bioemu': 'https://curieus.net/Analysis/bioemu?from=blog',
        'BioPhi': 'https://curieus.net/Analysis/biophi?from=blog',
        'Boltz-2': 'https://curieus.net/Analysis/boltz?from=blog',
        'Chai': 'https://curieus.net/Analysis/chai?from=blog',
        'DeepFRI': 'https://curieus.net/Analysis/deepfri?from=blog',
        'DeepEnzyme': 'https://curieus.net/Analysis/deepenzyme?from=blog',
        'DeepViscosity': 'https://curieus.net/Analysis/deepviscosity?from=blog',
        'Diffdock': 'https://curieus.net/Analysis/diffdock?from=blog',
        'DiliPred': 'https://curieus.net/Analysis/dilipred?from=blog',
        'DLKcat': 'https://curieus.net/Analysis/dlkcat?from=blog',
        'Dscript': 'https://curieus.net/Analysis/dscript?from=blog',
        'FixPDB': 'https://curieus.net/Analysis/fixpdb?from=blog',
        'GROMACS': 'https://curieus.net/Analysis/gromacs?from=blog',
        'Immunebuilder': 'https://curieus.net/Analysis/immunebuilder?from=blog',
        'LigandMPNN': 'https://curieus.net/Analysis/ligandmpnn?from=blog',
        'MHCflurry': 'https://curieus.net/Analysis/mhcflurry?from=blog',
        'NetSolP': 'https://curieus.net/Analysis/netsolp?from=blog',
        'PLIP': 'https://curieus.net/Analysis/plip?from=blog',
        'ToxinPred3': 'https://curieus.net/Analysis/toxinpred3?from=blog',
        'HEMOPI2': 'https://curieus.net/Analysis/hemopi?from=blog',
        'hERG': 'https://curieus.net/Analysis/herg?from=blog',
        'PIGNET2': 'https://curieus.net/Analysis/pignet2?from=blog',
        'PocketGen': 'https://curieus.net/Analysis/pocketgen?from=blog',
        'PRODIGY': 'https://curieus.net/Analysis/prodigy?from=blog',
        'ProteinMPNN': 'https://curieus.net/Analysis/proteinmpnn?from=blog',
        'RDKit': 'https://curieus.net/Analysis/rdkit?from=blog',
        'REINVENT4': 'https://curieus.net/Analysis/reinvent4?from=blog',
        'RFantibody': 'https://curieus.net/Analysis/rfantibody?from=blog',
        'RFdiffusion': 'https://curieus.net/Analysis/rfdiffusion-v2?from=blog',
        'StrucToxNet': 'https://curieus.net/Analysis/structoxnet?from=blog',
        'TemStaPro': 'https://curieus.net/Analysis/temstapro?from=blog',
        'ThermoMPNN ': 'https://curieus.net/Analysis/thermompnn?from=blog',
      };
  ...
  processedContent = processedContent.replace(
    ...
    (match, toolName) => {
      const toolUrls: { [key: string]: string } = {
        ...
        'ADMET-AI': 'https://curieus.net/Analysis/admet-ai?from=blog',
        'Antifold': 'https://curieus.net/Analysis/antifold?from=blog',
        'Bioemu': 'https://curieus.net/Analysis/biolemo?from=blog',
        'Boltz-2': 'https://curieus.net/Analysis/boltz?from=blog',
        'Chai': 'https://curieus.net/Analysis/chai-1?from=blog',
        'DeepFRI': 'https://curieus.net/Analysis/deepfri?from=blog',
        'DiffDock': 'https://curieus.net/Analysis/DiffDock?from=blog',
        'DLKcat': 'https://curieus.net/Analysis/dlkcat?from=blog',
        'D-SCRIPT': 'https://curieus.net/Analysis/dscript?from=blog',
        'FixPDB': 'https://curieus.net/Analysis/fixpdb?from=blog',
        'GROMACS': 'https://curieus.net/Analysis/gromacs?from=blog',
        'ImmuneBuilder': 'https://curieus.net/Analysis/immunebuilder?from=blog',
        'LigandMPNN': 'https://curieus.net/Analysis/ligandmpnn?from=blog',
        'MHCflurry': 'https://curieus.net/Analysis/mhcflurry2?from=blog',
        'NetSolP': 'https://curieus.net/Analysis/netsolp?from=blog',
        'PLIP': 'https://curieus.net/Analysis/plip?from=blog',
        'ToxinPred3': 'https://curieus.net/Analysis/toxinpred3?from=blog',
      };
